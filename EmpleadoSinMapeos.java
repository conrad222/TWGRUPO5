...
public class EmpleadoSinMapeos implements Serializable {
	...
	public EmpleadoSinMapeos() {
		super();
	}
	
	public EmpleadoSinMapeos(Long id, String nombre, String ape) {
		this.id = id;
		this.nombre =nombre;
		this.apellidos = ape;
	}
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		EmpleadoSinMapeos other = (EmpleadoSinMapeos) obj;
		if (id == null) {
			if (other.id != null)
				return false;
